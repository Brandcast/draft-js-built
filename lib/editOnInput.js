...
function editOnInput(editor) {
  ...
  !(foundStartAndEnd !== undefined) ? process.env.NODE_ENV !== 'production' ? invariant(false, 'Error: could not find start and end keys in editOnInput.') : invariant(false) : void 0;
