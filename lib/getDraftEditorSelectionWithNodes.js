...
function getPointForNonTextNode(editorRoot, startNode, childOffset) {
  ...
  if (editorRoot === node) {
    node = node.firstChild;
    !(node && node.nodeType === 1 && typeof node.getAttribute === 'function' && node.getAttribute('data-contents') === 'true') ? process.env.NODE_ENV !== 'production' ? invariant(false, 'Invalid DraftEditorContents structure.') : invariant(false) : void 0;
    if (childOffset > 0) {
