...
function getAnonymizedDOM(node, getNodeLabels) {
  ...
  !(anonymized.nodeType === Node.ELEMENT_NODE) ? process.env.NODE_ENV !== 'production' ? invariant(false, 'Node must be an Element if it is not a text node.') : invariant(false) : void 0;
